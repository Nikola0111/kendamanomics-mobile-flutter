...
import 'package:kendamanomics_mobile/providers/tricks_page_provider.dart';
...
class TricksPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ChangeNotifierProvider(
          create: (context) => TricksPageProvider(tamaId: tamaId!),
          child: Consumer<TricksPageProvider>(
  ...
  String _formatTitle(TricksPageProvider provider) {
